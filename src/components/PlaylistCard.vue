<template>
    <div class="flex items-center p-4 gap-6 h-28 aspect-card border-stroke-100
    bg-card border rounded-md cursor-pointer duration-150 hover:border-stroke-200">
        <img class="aspect-square w-20 rounded-md"
